...
/**
 * Class used for creation of the custom dialog used for changing the setting of
 * the reader
 * 
 * @see Dialog
 */
...
{
	/**
	 * Create the dialog with default values from the Settings class object from
	 * the parameter
	 * 
	 * @param parentShell
	 ...
	 * @param setting
	 *            reference to the actual setting object
	 * 
	 * @see Settings
	 * @see MainWindow
	 */
	public SettingsDialog(final Shell parentShell, final MainWindow windowRef, final Settings settings)
	{
		super(parentShell);
	 ...
	 * 
	 * @param parent
	 *            reference to the parent composite object
	 */
	@Override
	protected Control createDialogArea(final Composite parent)
	{
		...
		final Label lblStartupBrowserPage = new Label(container, SWT.NONE);
		final FormData fd_lblStartupBrowserPage = new FormData();
